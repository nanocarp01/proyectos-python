...
class FaceDetector():
        ...
        if self.results.detections:
            for id, detection in enumerate(self.results.detections):
                ...
                if draw:
                    ...
                    cv2.putText(img, f'{int(detection.score[0] * 100)}%', (bbox[0], bbox[1] - 20), cv2.FONT_HERSHEY_PLAIN, 2, (0, 255, 0), 2) #porcentaje
        return img, bboxs
    ...
    def fancyDraw(self, img, bbox, l=30, t=5, rt=1):
        ...
        cv2.rectangle(img, bbox, (0, 255, 0), rt)  #rectangulo
        # Top Left x,y
...
def main():
    ...
    while True:
        ...
        fps = 1 / (cTime - pTime)
        pTime = cTime
        cv2.putText(img, f'FPS: {int(fps)}', (20, 70), cv2.FONT_HERSHEY_PLAIN, 3, (0, 0, 255), 2)  # FPS
